...
const CONTRACTS = Object.freeze( {
	...
	'CHAMELEON-SIM': {
		...
		sources: [
			...
			'src/chameleon-lab/support-cohort-model.js',
			'src/chameleon-lab/surface-appearance.js',
			'src/chameleon-lab/surface-camouflage.js',
			'src/chameleon-lab/surface-contact-model.js',
			'src/chameleon-lab/surface-navigation-graph.js',
			'src/chameleon-lab/surface-route-debug-view.js',
		...
		tests: [
			...
			'test/chameleon-lab-navigation-route.test.js',
			'test/chameleon-lab-platformer-integration.test.js',
			'test/chameleon-lab-physics-world.test.js',
			'test/chameleon-lab-route-debug-view.test.js',
			'test/chameleon-lab-route.test.js',
			'test/chameleon-lab-support-cohort.test.js',
			'test/chameleon-lab-surface-camouflage.test.js',
			'test/chameleon-lab-surface-navigation-graph.test.js',
			'test/chameleon-lab-ui-settings.test.js',
		...
		evidence: [
			...
			'CHAMELEON-LAB-NAVIGATION-001',
			'CHAMELEON-LAB-NAVIGATION-002',
			'CHAMELEON-LAB-NAVIGATION-003',
			'CHAMELEON-LAB-NAVIGATION-004',
			'CHAMELEON-LAB-NAVIGATION-005',
			'CHAMELEON-LAB-NAVIGATION-006',
			'CHAMELEON-LAB-NAVIGATION-007',
			'CHAMELEON-LAB-NAVIGATION-008',
			'CHAMELEON-LAB-NAVIGATION-009',
			'CHAMELEON-LAB-PLATFORMER-INTEGRATION-010',
			'CHAMELEON-LAB-ROUTE-DEBUG-001',
			'CHAMELEON-LAB-ROUTE-DEBUG-002',
			'CHAMELEON-LAB-SURFACE-NAV-001',
			'CHAMELEON-LAB-SURFACE-NAV-002',
			'CHAMELEON-LAB-SURFACE-NAV-003',
			'CHAMELEON-LAB-SURFACE-NAV-004',
			'CHAMELEON-LAB-SURFACE-NAV-005',
			'SUPPORT-COHORT-001',
			'SUPPORT-COHORT-002',
			'SUPPORT-COHORT-003',
			'SUPPORT-COHORT-004',
			...
			'CHAMELEON-LAB-CAMOUFLAGE-001',
			'CHAMELEON-LAB-CAMOUFLAGE-002',
			'CHAMELEON-LAB-CAMOUFLAGE-003',
			'CHAMELEON-LAB-CAMOUFLAGE-004',
			'CHAMELEON-LAB-CAMOUFLAGE-005',
			'CHAMELEON-LAB-CAMOUFLAGE-006',
			'CHAMELEON-LAB-CAMOUFLAGE-007',
