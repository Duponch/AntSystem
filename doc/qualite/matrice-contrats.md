...
| Laboratoire caméléon isolé : route dynamique exclusive, asset physique borné, commandes caméra-support, active ragdoll et queue limitée, pas Rapier à 120 Hz, interpolation stable, plafond de rattrapage et rejet des poses non finies | `test/chameleon-lab-route.test.js`, `test/chameleon-lab-physics-world.test.js`, `test/chameleon-lab-controller.test.js`, `test/chameleon-lab-active-ragdoll.test.js`, `test/chameleon-physical-asset.test.js` |
