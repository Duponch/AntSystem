...
| Laboratoire caméléon isolé : route dynamique exclusive ; géométrie source exacte avec `original_tail_vertices = 7206` ; contrat anatomique exportant longueurs, pivots et trois points par semelle ; un seul corps dynamique Rapier et collider composé ; quatre chaînes analytiques à ceinture mobile et appuis zygodactyles complets ; membres XPBD passifs uniquement en saisie/mode libre ; queue XPBD de treize nœuds avec auto-collision corps et sommeil sans jitter ; récupération du support d’impact sur mur/cylindre ; pas à 120 Hz, interpolation et rejet des poses non finies. Les transitions multi-surfaces, la qualité de la démarche et la déformation de peau restent des preuves runtime. | `test/chameleon-lab-route.test.js`, `test/chameleon-lab-physics-world.test.js`, `test/chameleon-lab-controller.test.js`, `test/chameleon-lab-anatomical-limb.test.js`, `test/chameleon-lab-whole-body-gait.test.js`, `test/chameleon-lab-passive-limbs.test.js`, `test/chameleon-lab-passive-tail.test.js`, `test/chameleon-lab-active-ragdoll.test.js` (`CHAMELEON-LAB-RAGDOLL-001` à `013`), `test/chameleon-lab-hybrid-controller-allocation.test.js`, `test/chameleon-physical-asset.test.js` |
